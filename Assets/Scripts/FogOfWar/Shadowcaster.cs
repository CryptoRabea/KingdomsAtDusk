...
namespace RTS.FogOfWar
{
    ...
    public class Shadowcaster
    {
        ...
        public class FogField
        {
            ...
            public void Reset(RTS_FogOfWar fogWar)
            {
        ...
        public void Initialize(RTS_FogOfWar fogWar)
        {
            this.fogWar = fogWar;
        ...
        private bool IsTileEmpty(Vector2Int quadrantPoint)
        {
            ...
            return (fogWar.levelData[levelCoordinates.x][levelCoordinates.y] == RTS_FogOfWar.LevelColumn.ETileState.Empty);
        }
        ...
        private bool IsTileObstacle(Vector2Int quadrantPoint)
        {
            ...
            return (fogWar.levelData[levelCoordinates.x][levelCoordinates.y] == RTS_FogOfWar.LevelColumn.ETileState.Obstacle);
        }
